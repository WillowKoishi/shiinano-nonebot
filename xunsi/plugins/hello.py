...
async def poke_shiinano_function(event:PokeNotifyEvent):
    ...
    await poke_shiinano_trigger.send(MessageSegment.at(event.get_user_id())+" 不要揉我！")
    await poke_shiinano_trigger.send(MessageSegment.record("file:///C:\\Users\\Administrator\\shiinano\\src\\audio\\eff\\ciallo.wav"))
